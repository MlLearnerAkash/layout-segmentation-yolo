...
def plot_image(img_path, results, category_mapping=None, suffix='test', show_labels=True, include_legend=True):
    ...
    plt.axis("off")
    # print(f"Saving image at:{os.path.basename(img_path).rsplit(".", 1)[0]}")
...
def main():
    ...
    SAVE_TEST_IMG = True
    model_path = '/home/akash/ws/layout-segmentation-yolo/runs/chkpt/best_doclaynet.pt'
    img_path = '/home/akash/ws/layout-segmentation-yolo/datasets/regional_data/telugu/telugu_upanishad1.png'
    threshold = 0.5
    nms_threshold = 0.7
